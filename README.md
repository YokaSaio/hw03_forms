...
Яндекс Практикум. Спринт 4. Итоговый проект. Расширение проекта Yatube v1: [hw02_community](https://github.com/YokaSaio/hw02_community):
...
1. Клонировать репозиторий:
   ...
   ```python
   git clone git@github.com:YokaSaio/hw03_forms.git
   ```
